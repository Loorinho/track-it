...
function RouteComponent() {
  ...
  return <section className='min-h-screen my-3 max-w-3xl mx-auto'>
    <h1 className='text-2xl font-semibold text-center'>Labels</h1>

    <Button className='my-5 cursor-pointer' onClick={() => setSheetOpen(true)}>
      Add Label
  ...
  <TableBody>
    {
      labels.map((label, index) => (
        <TableRow key={label._id}>
          ...
          <TableCell>
            {
              label.color && (
                <div className='flex items-center gap-2'>
                  <div style={{backgroundColor: label.color}} className='w-20 h-5 rounded-md px-2'>
          ...
          <TableCell className="text-right">{dateFormatter.format(label._creationTime)}</TableCell>
        </TableRow>
      ))
    }
  </TableBody>
